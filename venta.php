...
<head>
    ...
    $(document).ready(function(){
     $("#btn1").click(function(){
      ...
      $("#t1").append( "<tr><td>"+produc+"</td><td>"+canti+"</td><td>"+unita+"</td><td>"+su_to+"</td></tr>");
      $("input#producto").val("");
      $("input#cantidad").val("");
      $("input#unit").val("");
...
<h1 class="text-center" style="color:#7b3c3c"><i> Venta de Productos</i></h1>
<div class="container bg-white">
  ...
  <div class="row">
    ...
    <br><br>
    <button type="buttton" id="btn1 "   class="btn btn-primary ">Agregar Producto</button>
    </div>
    <div class="col-sm " style="border-style: solid; border-color: black;">
...
<div class="col-md-5 ml-auto">
    <label for="venta" ><b>Venta Total:</b> </label>
    <input type="text " id="total" name="total"  placeholder="0.0">
